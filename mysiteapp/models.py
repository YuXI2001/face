...
from mysiteapp.utils import create_face_data
...
class AttendanceSheet(models.Model):
    ...
    门禁识别表
    """
    user = models.ForeignKey(UserList, verbose_name='识别用户编号', on_delete=models.CASCADE)
    attendance_time = models.DateTimeField(verbose_name='识别时间', auto_now_add=True)
    attendance_img = models.ImageField('用户照片', upload_to='upload/')
    attendance_statu = models.BooleanField(verbose_name='门禁识别状态', default=False)
